...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "AdminLayout", $$AdminLayout, { "title": "新建小说" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex flex-col gap-6"> <div class="flex items-center gap-4"> <a href="/admin/novels"> ${renderComponent($$result2, "Button", Button, { "variant": "outline", "size": "icon", "className": "h-8 w-8" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "ArrowLeft", ArrowLeft, { "className": "h-4 w-4" })} <span class="sr-only">返回列表</span> ` })} </a> <div> <h1 class="text-2xl font-bold tracking-tight">新建小说</h1> <p class="text-muted-foreground">填写小说基本信息并创建新项目</p> </div> </div> ${renderComponent($$result2, "NovelForm", null, { "r2Domain": r2Domain, "client:only": "react", "client:component-hydration": "only", "client:component-path": "/Users/yangfuzhang/Desktop/wuxiadreams/wuxiadreams.com/src/pages/admin/novels/_components/novel-form", "client:component-export": "default" })} </div> ` })}`;
}, "/Users/yangfuzhang/Desktop/wuxiadreams/wuxiadreams.com/src/pages/admin/novels/create/index.astro", void 0);
const $$file = "/Users/yangfuzhang/Desktop/wuxiadreams/wuxiadreams.com/src/pages/admin/novels/create/index.astro";
const $$url = "/admin/novels/create";
