...
import { aW as ProviderError, aX as IniSectionType, aY as CONFIG_PREFIX_SEPARATOR, I as readFile, aZ as getConfigFilepath, a_ as parseIni, k as getProfileName, C as CredentialsProviderError, s as setCredentialFeature } from "./r2_fNuLAT3E.mjs";
import { promises } from "node:fs";
import { g as getSSOTokenFilepath, a as getSSOTokenFromFile } from "./getSSOTokenFromFile_8CqH-G7a.mjs";
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
  const { SSOOIDCClient } = await import("./index_8HK4X7eW.mjs");
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
  const { CreateTokenCommand } = await import("./index_8HK4X7eW.mjs");
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger }) => {
  ...
  const { SSOClient, GetRoleCredentialsCommand } = await import("./loadSso_C7E9ifaA.mjs");
