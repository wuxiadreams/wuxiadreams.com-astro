...
function drizzle(client, config = {}) {
  ...
  const session2 = new SQLiteD1Session(client, dialect, schema2, { logger, cache: config.cache });
...
const novel = sqliteTable(
  "novel",
  {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    titleAlt: text("title_alt").notNull(),
    title: text("title").notNull(),
    slug: text("slug").notNull().unique(),
    ...
    translatedLink: text("translated_link"),
...
const author = sqliteTable(
  "author",
  {
    id: text("id").primaryKey().$defaultFn(() => crypto.randomUUID()),
    name: text("name").notNull().unique(),
    nameAlt: text("name_alt").notNull().unique(),
    slug: text("slug").notNull().unique(),
...
const novelAuthor = sqliteTable(
  "novel_author",
  {
    novelId: text("novel_id").notNull().references(() => novel.id, { onDelete: "cascade" }),
...
const novelCategory = sqliteTable(
  "novel_category",
  {
    novelId: text("novel_id").notNull().references(() => novel.id, { onDelete: "cascade" }),
...
const novelAuthorRelations = relations(novelAuthor, ({ one }) => ({
  novel: one(novel, {
...
const novelTagRelations = relations(novelTag, ({ one }) => ({
  novel: one(novel, {
...
const novelCategoryRelations = relations(novelCategory, ({ one }) => ({
  novel: one(novel, {
...
const schema = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  novel,
  novelAuthor,
  novelAuthorRelations,
  novelCategory,
  novelCategoryRelations,
  novelRelations,
  novelTag,
  novelTagRelations,
  post,
